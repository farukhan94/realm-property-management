...
export const DOCUMENTS: DocumentRecord[] = [
  ...
  { id: "DOC-007", name: "RERA Broker License — Realm Bahrain W.L.L.", type: "policy", date: "2025-12-01", size: "0.5 MB", visibility: ["Admin"], entityId: "ent-mgmt" },
  { id: "DOC-008", name: "Sijilat CR Copy — Realm Property Management", type: "report", date: "2026-01-10", size: "0.3 MB", visibility: ["Admin"], entityId: "ent-mgmt" },
